...
import com.abdel.dell.piideo.service.HttpService;
...
import com.abdel.dell.piideo.helper.PrefManager;
        ...
        switch (view.getId()) {
            case R.id.btn_request_sms:
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_CONTACTS)
                    ...
                    ActivityCompat.requestPermissions(RegistrationActivity.this, new String[]{Manifest.permission.READ_CONTACTS}, REQUEST_CODE);
                } else {
                    validateForm();
                }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Fro Testing purpose
                         */
                        inputOtp.setText(message.split(":")[1].trim());
